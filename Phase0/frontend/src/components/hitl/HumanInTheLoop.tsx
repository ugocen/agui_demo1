 ...
 * are from `resources/07-phase0-claude-code-plan.md` §4 (the G0 HITL cards). The
 * form/choice tools (`draft_bug_report`, `ask_choice`, `draft_press_release`)
 * follow their agents' docstrings; their exact response shape should be confirmed
