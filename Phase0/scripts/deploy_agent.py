...
Configuration comes only from Phase0/.env. The console flow in doc 02
"Phase 0 deployment procedure" produces an identical runtime.
"""
...
def main() -> None:
    ...
    model_id = require(env, "BEDROCK_MODEL_ID")
